...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    /**
     * A dummy authentication store containing known user names and Password.
...
//        name = (EditText)findViewById(R.id.name);
        mEmailView = (AutoCompleteTextView)viewGroup.findViewById(R.id.email);
        populateAutoComplete();

        mPassordView = (EditText) viewGroup.findViewById(R.id.password);
//        mPassordView.setOnEditorActionListener(new TextView.OnEditorActionListener() {
//            @Override
...
//        });
    ...
    public void toSignup(View arg0) {
...
//        }
        ...
        mPassordView.setError(null);

        // Store values at the time of the login attempt.
        String email = mEmailView.getText().toString();
        String password = mPassordView.getText().toString();
...
//        showProgress(true);
            ...
            if (error instanceof HttpException) {
                ...
                try {
                    ...
                    System.out.println("Error 2"+response.getMessage());
...
//                mPhoneView.setError(getString(R.string.error_incorrect_Phone));
    ...
    private void showSnackBarMessage(String message) {
        View view = getLayoutInflater().inflate(R.layout.activity_login,viewGroup ,true);
