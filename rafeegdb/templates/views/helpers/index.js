...
module.exports = function () {
	...
	_helpers.commentUrl = function (commentsSlug, options) {
		return ('/post/' + commentsSlug);
	};
	// create the category url for a blog-category page
	_helpers.classisUrl = function (classisSlug, options) {
		return ('/blog/' + classisSlug);
	};
	_helpers.classisNewsUrl = function (classisSlug, options) {
		return ('/news/' + classisSlug);
	};
	_helpers.classItemUrl = function (classItemSlug, options) {
		return ('/class/' + classItemSlug);
	};
